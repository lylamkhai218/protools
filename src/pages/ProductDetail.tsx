...
export default function ProductDetail({ product, onAddToCart, onNavigate, onSelectProduct }: ProductDetailProps) {
  ...
  const tabs = [
    ...
    { id: 'apps', label: 'Ứng dụng tiêu biểu' },
    { id: 'docs', label: 'Tài liệu hướng dẫn' }
  ];
  ...
  return (
    <div className="flex-1 bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="text-xs text-zinc-500 mb-6 flex items-center gap-1.5 font-sans">
          <span className="hover:text-primary cursor-pointer" onClick={() => onNavigate('home')}>Trang chủ</span>
          <span>/</span>
          <span className="hover:text-primary cursor-pointer" onClick={() => onNavigate('robot')}>Robot</span>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="relative border border-zinc-200 rounded-xs overflow-hidden aspect-square bg-zinc-50 flex items-center justify-center group">
              ...
              <button 
                ...
                className="absolute bottom-4 right-4 bg-zinc-950/80 hover:bg-zinc-950/95 text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center"
              >
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              {/* Simulated video thumbnail placeholder to match visual of image */}
              <button 
                onClick={() => setShowVideoModal(true)}
                className="border border-zinc-200 bg-zinc-100 rounded-xs flex flex-col items-center justify-center text-center p-1.5 hover:border-[#005eb8] group transition-colors aspect-square"
              >
                <Play className="h-5 w-5 text-zinc-500 group-hover:text-primary group-hover:scale-115 transition-transform" />
                <span className="text-[10px] text-zinc-400 font-display font-semibold mt-1 uppercase tracking-wider">Demo Video</span>
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div>
              ...
              <h1 className="font-display text-3xl sm:text-4xl font-extrabold text-[#00478d] leading-tight uppercase">
                {product.name}
              </h1>
            </div>
            ...
            <div className="bg-zinc-50 border border-zinc-200/60 rounded-xs p-4 grid grid-cols-3 gap-4 text-center divide-x divide-zinc-200">
              <div>
                <span className="text-[11px] text-zinc-400 uppercase tracking-widest font-display block">Tốc độ tối đa</span>
                <span className="font-display font-extrabold text-[#00478d] text-lg sm:text-xl block mt-1">800 mm/s</span>
              </div>
              <div>
                <span className="text-[11px] text-zinc-400 uppercase tracking-widest font-display block pl-2">Độ lặp lại</span>
                <span className="font-display font-extrabold text-[#00478d] text-lg sm:text-xl block mt-1 pl-2">± 0.01 mm</span>
              </div>
              <div>
                <span className="text-[11px] text-zinc-400 uppercase tracking-widest font-display block pl-2">Vùng làm việc</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-zinc-100 text-xs text-zinc-500">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <strong className="font-semibold block text-zinc-700">Bảo hành chính hãng</strong>
                  <span className="text-[11px] text-zinc-400">12 tháng tiêu chuẩn của Hakko VN</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5">
                <Award className="h-4 w-4 text-tertiary" />
                <div>
                  <strong className="font-semibold block text-zinc-700">Hỗ trợ kỹ thuật 24/7</strong>
                  <span className="text-[11px] text-zinc-400">Tư vấn lắp đặt &amp; căn chỉnh trục miễn phí</span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-12">
              ...
              {activeTab === 'specs' && (
                <div className="space-y-6 animate-fade-in">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="font-display text-xl sm:text-2xl font-extrabold uppercase text-zinc-900 tracking-tight">Thông số kỹ thuật</h2>
                  </div>
              ...
              {activeTab === 'apps' && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="font-display text-xl sm:text-2xl font-extrabold uppercase text-zinc-900 tracking-tight">Ứng dụng tiêu biểu</h2>
                  </div>
              ...
              {activeTab === 'docs' && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="font-display text-xl sm:text-2xl font-primary font-extrabold uppercase text-zinc-900 tracking-tight">Tài liệu &amp; Hướng dẫn</h2>
                  </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#00478d] p-6 text-white rounded-xs space-y-4 relative overflow-hidden">
              ...
              <h4 className="font-display text-lg font-bold uppercase tracking-tight">Cần tư vấn kỹ thuật?</h4>
              <p className="text-xs text-zinc-200 font-light leading-relaxed">
                Kỹ sư của T&amp;T Vina sẽ giải đáp thắc mắc về kỹ thuật, chọn mã model hoặc tư vấn tùy chỉnh cấu hình thiết kế trực tiếp 24/7.
              </p>
              <button 
      ...
      {addedItemName && (
        <div className="fixed bottom-6 left-6 z-[120] bg-zinc-950 text-white border border-zinc-800 rounded-lg shadow-2xl p-4 max-w-sm flex gap-3 items-center animate-slide-in">
          ...
          <div>
            <p className="text-xs text-zinc-400">Đã cập nhật giỏ hàng!</p>
      ...
      {showVideoModal && (
        <div className="fixed inset-0 bg-stone-900/80 backdrop-blur-md z-[150] flex items-center justify-center p-4">
          <div className="bg-black text-white w-full max-w-3xl rounded-lg overflow-hidden border border-zinc-800 relative aspect-video">
            <iframe 
            ...
            <button 
              ...
              className="absolute top-4 right-4 bg-zinc-900 hover:bg-zinc-800 text-white hover:text-primary p-2 h-8 w-8 rounded-full border border-zinc-600 flex items-center justify-center font-bold text-xs"
            >
              ✕
            </button>
          </div>
