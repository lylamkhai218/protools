...
export const FlagIcon: React.FC<FlagIconProps> = ({
  ...
  switch (country) {
    case 'vi':
      ...
      return (
        ...
        >
          ...
          <polygon
            fill="#FFFF00"
            points="9,2.4 9.81,4.89 12.42,4.89 10.31,6.43 11.12,8.91 9,7.38 6.88,8.91 7.69,6.43 5.58,4.89 8.19,4.89"
          />
        </svg>
      );
    ...
    case 'ko':
      // South Korea Flag: White field with horizontal Taegeuk (Red top, Blue bottom) and 4 trigrams
      return (
        <svg
          viewBox="0 0 18 12"
          width={width}
        ...
        >
          ...
          <g transform="translate(9,6)">
            ...
            <path d="M -2.6,0 A 2.6,2.6 0 0,1 2.6,0 A 1.3,1.3 0 0,0 0,0 A 1.3,1.3 0 0,1 -2.6,0" fill="#CD2E3A" />
            <path d="M 2.6,0 A 2.6,2.6 0 0,1 -2.6,0 A 1.3,1.3 0 0,0 0,0 A 1.3,1.3 0 0,1 2.6,0" fill="#0047A0" />
            {/* Top-Left: Geon (3 solid bars) */}
            <g transform="rotate(-56.3) translate(0,-4.5)">
              <rect x="-1.2" y="-0.48" width="2.4" height="0.26" fill="#000000" />
              <rect x="-1.2" y="-0.13" width="2.4" height="0.26" fill="#000000" />
              <rect x="-1.2" y="0.22" width="2.4" height="0.26" fill="#000000" />
            </g>
            {/* Bottom-Right: Gon (3 broken bars) */}
            <g transform="rotate(-56.3) translate(0,4.5)">
              <rect x="-1.2" y="-0.48" width="1.05" height="0.26" fill="#000000" />
              <rect x="0.15" y="-0.48" width="1.05" height="0.26" fill="#000000" />
              <rect x="-1.2" y="-0.13" width="1.05" height="0.26" fill="#000000" />
              <rect x="0.15" y="-0.13" width="1.05" height="0.26" fill="#000000" />
              <rect x="-1.2" y="0.22" width="1.05" height="0.26" fill="#000000" />
              <rect x="0.15" y="0.22" width="1.05" height="0.26" fill="#000000" />
            </g>
